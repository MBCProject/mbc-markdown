...
|---|---|---|---|
|[**BlackEnergy**](../xample-malware/blackenergy.md)|October 2007|B0033|Launches distributed denial of service attacks that can target more than one IP address per hostname. [[1]](#1)|
|[**GoBotKR**](../xample-malware/gobotkr.md)|2019|B0033|GoBotKR has been used to execute endpoint DDoS attacks – for example, TCP Flood or SYN Flood. [[2]](#2)|
