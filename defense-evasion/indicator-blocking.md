...
|---|---|---|---|
|[**BlackEnergy**](../xample-malware/blackenergy.md)|2007|F0006|Clears windows event logs and removes the watermark associated with enabling the TESTSIGNING boot configuration option by removing the relevent strings in the user32.dll.mui of the system  [[1]](#1)|
|[**Conficker**](../xample-malware/conficker.md)|2008|F0006|Terminates various services related to system security and Windows and prevents network access to various websites related to antivirus software  [[2]](#2)|
|[**TrickBot**](../xample-malware/trickbot.md)|2016|F0006|Terminates the following anti-malware services: Window Defender, MBamService (Malwarebytes), SAVService (Sophos AV) [[4]](#4)|
|[**Dark Comet**](../xample-malware/dark-comet.md)|2008|F0006|Can disable security center functions like anti-virus and firewall [[3]](#3)|
